              ...
              <div className="func-1">
                <div>
                  ...
                  <div className="link-of-func-1">
                    <img title="Dành cho bạn" alt="Dành cho bạn" src="/logos/home.png" />
                    <h2>Dành cho bạn</h2>
                  </div>
                </div>
                <div>
                  <div className="link-of-func-1">
                    <img title="Đang Follow" alt="Đang Follow" src="/logos/following.png" />
                    <h2>Đang Follow</h2>
                  </div>
                </div>
                <div>
                  <div className="link-of-func-1">
                    <img title="Livestream" alt="Livestream" src="/logos/livestream.png" />
                    <h2>Live</h2>
                  </div>
                </div>
              </div>
